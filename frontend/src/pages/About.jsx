    ...
    <div className="min-h-screen" style={{ backgroundColor: colors.surface }}>
      ...
      >
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle at 10% 30%, ${colors.secondary}30, transparent 70%)`,
          }}
        />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              >
                LegalSetu is a full-service law firm providing expert legal
              ...
              <div className="grid grid-cols-3 gap-4">
                <div
                  className={`${glassCardClass} p-4 text-center`}
                  style={{
            ...
            <div className="relative">
              <div
                className={`relative rounded-xl overflow-hidden ${glassCardClass} p-2`}
              >
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div
                    ...
                    style={{ borderTopColor: colors.outlineVariant }}
                  >
                    <div>
                      <span
                        className="text-xs"
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p
            className="mb-4"
            style={{ color: colors.onPrimaryContainer, lineHeight: "1.5" }}
          >
          ...
          >
            © 2025 LegalSetu Legal Tech. All Rights Reserved.
          </div>
        </div>
      </footer>
    </div>
