        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <UserCircle className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5" style={{ color: colors.outline }} />
              <input
                type="text"
                name="name"
                value={form.name}
          ...
          <div>
            ...
            <div className="relative">
              <User className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5" style={{ color: colors.outline }} />
              <input
                type="text"
                name="username"
                value={form.username}
            ...
            {form.password && (
              <div className="mt-3">
                ...
                <div className="flex justify-between items-center mt-2">
                  <p className="text-xs" style={{ color: strengthConfig[passwordStrength]?.color }}>
                ...
                <p className="text-[10px] mt-1" style={{ color: colors.onSurfaceVariant }}>
