...
export default function TermsAndConditions() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: colors.surface }}>
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <Link to="/" className="flex items-center space-x-2 group">
              <div className={`p-1.5 rounded-xl transition-all duration-300 ${!scrolled ? glassCardClass : ""}`}>
                <img 
                  src={appLogo} 
                  alt="LawSetu Logo" 
            ...
            <button
              ...
              style={{ backgroundColor: scrolled ? colors.surfaceContainerHighest : "transparent" }}
              onClick={() => setIsMenuOpen(!isMenuOpen)}
            >
              {isMenuOpen ? (
                <X className="h-5 w-5" style={{ color: colors.onSurfaceVariant }} />
              ) : (
                <Menu className="h-5 w-5" style={{ color: colors.onSurfaceVariant }} />
              )}
            </button>
          </div>
        </div>
                  ...
                  {tableOfContents.map((item, index) => (
                    <li key={item.id}>
                      <button
                        ...
                        onMouseLeave={(e) => e.currentTarget.style.color = colors.onSurfaceVariant}
                      >
                        <span className="text-sm">{(index + 1).toString().padStart(2, '0')}. {item.label}</span>
            ...
            <main className="flex-1 py-8 lg:py-12">
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center space-x-4 text-sm">
                  <div className="flex items-center space-x-1">
                    <Clock className="h-4 w-4" style={{ color: colors.onSurfaceVariant }} />
                    <span style={{ color: colors.onSurfaceVariant }}>Last updated: January 2025</span>
                  </div>
                  <div className="flex items-center space-x-1">
                    <Shield className="h-4 w-4" style={{ color: colors.onSurfaceVariant }} />
              ...
              >
                <div className="flex items-start">
                  <AlertCircle className="h-5 w-5 flex-shrink-0 mt-0.5 mr-3" style={{ color: colors.secondary }} />
              ...
              <div className="space-y-8">
                ...
                <section id="acceptance" className="scroll-mt-20">
                  <h2 className="text-xl md:text-2xl font-bold mb-4 flex items-center" style={{ color: colors.onSurface }}>
                    <span 
                  ...
                  <div className="space-y-3" style={{ color: colors.onSurfaceVariant }}>
                ...
                <section id="obligations" className="scroll-mt-20">
                  ...
                  <div className="space-y-3" style={{ color: colors.onSurfaceVariant }}>
                    <p className="leading-relaxed">When using LawSetu, you agree NOT to:</p>
                    <ul className="list-disc pl-6 space-y-2">
                ...
                <section id="termination" className="scroll-mt-20">
                  ...
                  <div className="space-y-3" style={{ color: colors.onSurfaceVariant }}>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li>You must delete all copies of any content from the Platform</li>
                ...
                <section id="liability" className="scroll-mt-20">
                  ...
                  <div className="space-y-3" style={{ color: colors.onSurfaceVariant }}>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li>Any damages related to services not supplied by us</li>
                    </ul>
                    <p className="leading-relaxed">
                ...
                <section id="contact" className="scroll-mt-20">
                  ...
                  <div className="space-y-3" style={{ color: colors.onSurfaceVariant }}>
                    ...
                    >
                      <p><strong style={{ color: colors.onSurface }}>LawSetu</strong></p>
      ...
      {/* Footer */}
      <footer className="py-8 mt-12" style={{ backgroundColor: colors.primary, borderTop: `1px solid ${colors.primaryContainer}` }}>
        <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              ...
              />
              <span className="font-bold text-white">Law<span style={{ color: colors.secondary }}>Setu</span></span>
            </div>
            <div className="flex space-x-6 text-sm">
              <Link
                ...
                onMouseEnter={(e) => e.currentTarget.style.color = colors.secondary}
                onMouseLeave={(e) => e.currentTarget.style.color = colors.onPrimaryContainer}
              >
                Terms
              </Link>
              <Link
            ...
            <p className="text-sm mt-4 md:mt-0" style={{ color: colors.onPrimaryContainer }}>
