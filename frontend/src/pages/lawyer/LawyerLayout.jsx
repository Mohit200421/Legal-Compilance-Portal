...
const LawyerLayout = () => {
  ...
  const navItems = [
    ...
    { to: "/lawyer/profile", icon: User, label: "My Profile" },
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center ${
                      ...
                      isActive
                        ? "bg-gradient-to-r from-secondary/10 to-transparent text-secondary"
                        : "text-onSurfaceVariant hover:bg-surfaceContainerHighest hover:text-onSurface"
                    }`
                  }
                  style={({ isActive }) => ({
